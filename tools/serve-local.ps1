...
$types = @{ ".html"="text/html; charset=utf-8"; ".js"="application/javascript"; ".css"="text/css"; ".asclv"="application/octet-stream"; ".ascl"="application/octet-stream"; ".mp3"="audio/mpeg"; ".mp4"="video/mp4"; ".webm"="video/webm"; ".tsv"="text/plain; charset=utf-8"; ".png"="image/png"; ".bin"="application/octet-stream"; ".md"="text/plain; charset=utf-8"; ".txt"="text/plain; charset=utf-8" }
