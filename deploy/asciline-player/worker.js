/* Worker `asciline-player` — código EXACTO que está desplegado en Cloudflare
   ...
   - **Tipos de video** (`mp4`, `webm`) y `tsv`. Antes cualquier extensión
     desconocida salía `application/octet-stream`: servir así el pack v0
     habría dado un falso negativo —muchos WebViews de TV miran el
...
var TYPES={html:'text/html; charset=utf-8',js:'application/javascript; charset=utf-8',png:'image/png',asclv:'application/octet-stream',slots:'application/octet-stream',txt:'text/plain; charset=utf-8',json:'application/json',mp4:'video/mp4',webm:'video/webm',tsv:'text/plain; charset=utf-8'};
