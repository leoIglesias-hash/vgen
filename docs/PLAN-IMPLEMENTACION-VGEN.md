...
| **H-23 — la imagen que gira encima del alfa** (ejecutada 2026-09-05; falta la foto) | ¿una imagen rotada por `drawImage` a 15 fps encima del incentivador con alfa le cuesta un cuadro a la caja? (pedido del operador: «esa prueba no la hicimos… siempre pensando en eficiencia») | `7` cicla en `producto.html`; `logo.png`; pintada cronometrada por carga | foto: `7` `7`, `4`, `9` (SPEC §12.6); en la PC: 0,20 ms med / 2,2 max por pintada |
