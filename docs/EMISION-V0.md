...
| **S5** | **sostenida en la clase principal (2026-09-04)**: canvas a 15 fps encima = 0/155 caídos vs 1/156 sin, en Baseline y VP9 → **encima** | la PC como refutadora |
...
| **S13** | **Una pieza con audio muxeado** (AAC en mp4 / Opus en WebM) reproduce en la caja sin perder fluidez ni sincronía | audio y video son bloques de hardware distintos; es el caso más rodado del planeta | pierde cuadros o el audio se desfasa → el audio de las piezas va por `<audio>` aparte con cue, y la sincronía exacta se abandona. Se mide con la emisión v1 (H-6), que suma la pista del máster |
