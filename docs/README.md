...
| [`EMISION-V2.md`](EMISION-V2.md) | **H-26 (2026-09-07)**: el video desde la fuente, no del máster indexado («el look fue un medio»): la cadena v1 vs v2 paso a paso (1280@20 lanczos, 709 explícito, VP9 dos pasadas + alt-ref, H.264 High, radio de la fuente, `dash-v2-vp9/`, techo 20 MB), la receta de arranque, cómo se emite y se barre desde la PC con `emitir.cmd -Fuente`, y qué falta para cerrar (CI después, por pedido del operador) |
...
| [`DISENO-CALIDAD-VGEN.md`](DISENO-CALIDAD-VGEN.md) | **debate abierto (2026-09-07)**: dónde pierde calidad la cadena de hoy (medido vs supuesto) y seis palancas del encoder con costo cero en el aparato (color 709, VP9 dos pasadas, máster sin pérdida, 24 fps/1920, calidad por corte, escalera por clase); cuatro preguntas al operador antes de medir. P-009. |
