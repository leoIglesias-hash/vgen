...
### Lo que hay que traer de la próxima visita (una sola, tres puntos)

Actualizado con la **segunda foto del 2026-09-04 (noche)**, que cerró dos puntos
más: los **dos planos se sostienen** (`dos:vp9+alfa` 2/154 abajo y 1/141 arriba,
H-18b **cerrada**) y la **pantalla entera está medida** (H-20 **cerrada**), con
el hallazgo de diseño que salió de ahí: **el presupuesto de composición es DOS
planos, no tres** —video + video alfa 2,6 %, video + capa 0 %, **los tres juntos
11 %**—. De la foto anterior venían cerrados el techo en tandas (H-12b), Hobo
(H-16) y el pantallazo (W-26/W-26b).
...
| 3 | `71` | **los dos planos en bucle, a toda la superficie y sin cortes**, el rato que haga falta: ¿se ve fluido de verdad, o se nota que pierde? El zócalo va contando los caídos vivos de los dos. Los cortes que se vieron con el `70` eran de la medición —cuatro escalones— y no del aparato | H-21 |
