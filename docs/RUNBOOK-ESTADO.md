...
### Lo que hay que traer de la próxima visita (una sola, cuatro puntos)

Actualizado con la **foto del 2026-09-04 (noche)** y con el reporte del `6` de
esa misma noche, que cerraron tres puntos de la lista anterior: el techo aguantó
**50 MB en tandas de 5 MB con la app viva** (H-12b), la capa se dibujó **en
Hobo, 166 ms** (H-16 **cerrada**) y la raíz abrió **sin pantallazos** con
`?renderer=canvas2d` (**W-26 y W-26b cerradas**). Lo que sigue abierto, más lo
que esa misma foto hizo aparecer.
